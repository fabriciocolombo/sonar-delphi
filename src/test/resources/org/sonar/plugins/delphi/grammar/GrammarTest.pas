...
type
    ...
    myClass = CLASS( templateClass<myTemplate, string>, blah)                        //<> problems
        ...
        property Items[Index : Integer] : TCrewLinkListItem read GetItem;
        default;    //default at end
        property Version : string read  GetVersion write SetVersion stored False;
        //stored False consumed additional ';' token
    ...
    overloadClass = Class
        ...
        overload                    //; not needed at the end of overload to compile
            procedure foo(z: real);
        overload
...
begin
    ...
    unicodeString := 'âûÿâ³¢ ñïðîáó âûêë³êàöü â³ðòóàëüíû ìåòàä âûçâàëåíàãà àá''åêòà. Çàðàç áóäçå âûêë³êàíà ïàðóøýííå
    äîñòóïó äëÿ ïåðàïûíåííÿ áÿãó÷àé àïåðàöû³.';
